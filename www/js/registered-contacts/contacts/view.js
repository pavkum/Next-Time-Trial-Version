define(['jquery',
        ...
        'backbone' ,
        'utils/user/icon',
        'text!registered-contacts/contacts/templates/registered-contact.html'
       ] , function($ , _ , Backbone , userIcon , registeredContact){

      return Backbone.View.extend({

        el : '.contacts',

        template : _.template(registeredContact),
