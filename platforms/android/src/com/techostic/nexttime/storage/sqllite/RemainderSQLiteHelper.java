package com.techostic.nexttime.storage.sqllite;
...
import com.techostic.nexttime.storage.RemainderAPI;
...
public class RemainderSQLiteHelper extends SQLiteOpenHelper implements RemainderAPI{
	...
	public List<Remainder> getAllPendingRemaindersByContactID(long contactID) {
		...
		try{
			...
			Log.d("remainderList", "remainderList for contact ID : "+contactID + " : "+remainderList.toString());
