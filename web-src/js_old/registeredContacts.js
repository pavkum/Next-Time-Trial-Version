...
*/
    ...
    var layoutFix = function (){
        var workareaHeight = elem.height();
        var addContactHeight = elem.find('.addContact').outerHeight();
        
        var wrapper = elem.find('.wrapper');
        wrapper.height(workareaHeight - addContactHeight);
    ...
    $('body').on('showTechoContacts',function (){
        ...
        def.done(function (){
            ...
            $('#version').text(window.location.hash);
